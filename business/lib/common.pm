...
use Data::Dumper;
use strict;
# use constant LOGDIR => qq{/home/william/scraper_logs/}; # should change!
# use constant LOGDIR => qq{/cygdrive/c/Users/ingrid/Desktop/William Projects/logs/};
# use constant LOGDIR => qq{../log/};		#doesn't work.
