...
require Exporter;
@ISA = qw( Exporter );
@EXPORT = qw(USER PASS HOST DSN LOGDIR CHTML URL1 URL2 URL3 URL4 URL5 URL6 CATEGORY CITY COUNTRY_STATE ITEM TOPIC DEFAULT_CITY DEFAULT_CATEGORY
VERSION INTERVAL_DATE CUT_LENGTH USJOBS USSERVICES USGIGS US_DATEFORMAT CA_DATEFORMAT);
